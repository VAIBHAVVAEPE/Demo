...
namespace Puzzle
{
    class JavaQuestions
    {
        ...
        public void AddJavaQuestions()
        {
            ...
            al.Add("\tQ3.___ is used to find and fix bugs in the Java programs.");
            Q3op.Add("\t\t1.JVM");
            Q3op.Add("\t\t2.JRE");
            Q3op.Add("\t\t3.JDK");
            Q3op.Add("\t\t4.JDB");
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\t\t\t\t Hello " + name + ", Lets Play A Puzzle...");
            Console.WriteLine();
            Console.WriteLine("Press 1 For Java Puzzle \nPress 2 for c# Puzzle");
